...
document.getElementById("yabanciDizi").addEventListener("change",yabanciDiziGoster);
document.getElementById("yerliDizi").addEventListener("change",yerliDiziGoster);
document.getElementById("yabanciFilm").addEventListener("change",yabanciFilmGoster);
document.getElementById("yerliFilm").addEventListener("change",yerliFilmGoster);

console.log(sonucbaslik)


function yabanciDiziGoster(){
    
    sonucbaslik.classList.remove("vh","me","ge","fo","or" ,"normal");
    yabanciDizi=document.getElementById("yabanciDizi").selectedIndex;
    console.log(yabanciDizi)
...
function yerliDiziGoster(){
    ...
    function yabanciFilmGoster(){
        sonucbaslik.classList.remove("pa" ,"km", "du", "ti", "de" ,"normal");
        yabanciFilm=document.getElementById("yabanciFilm").selectedIndex;
        console.log(yerliDizi)
    ...
    function yerliFilmGoster(){
        sonucbaslik.classList.remove("hs" ,"aş", "7k", "ats", "kc" ,"normal");
        yerliFilm=document.getElementById("yerliFilm").selectedIndex;
        console.log(yerliDizi)
